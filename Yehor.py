...
import telebot
# Указываем токен
bot = telebot.TeleBot('2141530179:AAGLsNUWWG93lQZlt__sDze2m_B3F6lj5xc')
...
def get_text_messages(message):
    ...
    if message.text == "Дороу":
        # Пишем приветствие
        bot.send_sticker(message.chat.id, "CAACAgIAAxkBAAEDUe5hl6v7QnHcZR3jc3GAn-kZnRGL0QACQAADOPCiGncMZgcCUVNuIgQ")
        ...
        bot.send_message(message.from_user.id, "Напиши Дороу")
    else:
